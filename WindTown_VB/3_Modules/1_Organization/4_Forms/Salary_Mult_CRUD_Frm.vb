...
Public Class Salary_Mult_CRUD_Frm
    ...
    Private Sub InitComboBox()
        ...
        Dim jobSV As JobService = New JobService()
        Dim response = jobSV.Execute(DataIntent.GetList)
        ...
        Dim lvlSV As BaseService(Of Level) = New BaseService(Of Level)
        response = lvlSV.Execute(DataIntent.GetList)
