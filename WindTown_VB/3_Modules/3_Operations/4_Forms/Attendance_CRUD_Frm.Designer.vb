...
Partial Class Attendance_CRUD_Frm
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label2.Text = "Tổng giờ hành chính:"
        '
        'ui_office_hours
        '
        ...
        Me.Label7.Text = "Tổng giờ tăng ca:"
        '
        'ui_overtime_hours
        '
        ...
        Me.Label9.Text = "Tổng giờ về sớm:"
        '
        'ui_early_hours
        '
        ...
        Me.Label10.Text = "Tổng giờ đi muộn:"
        '
        'Attendance_CRUD_Frm
        '
