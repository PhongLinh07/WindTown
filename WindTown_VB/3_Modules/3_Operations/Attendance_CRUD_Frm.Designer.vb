...
Partial Class Attendance_CRUD_Frm
    ...
    Private Sub InitializeComponent()
        ...
        Label3.Location = New Point(867, 93)
        ...
        ui_status.Location = New Point(872, 113)
        ...
        ui_note.Location = New Point(872, 208)
        ...
        Label4.Location = New Point(867, 190)
        ...
        ui_employee.Location = New Point(74, 212)
        ...
        Label5.Location = New Point(69, 395)
        ...
        Label6.Location = New Point(69, 294)
        ...
        Label8.Location = New Point(69, 93)
        ...
        Label9.Location = New Point(472, 395)
        ...
        Label10.Location = New Point(472, 294)
        ...
        ui_office_hours.Location = New Point(477, 111)
        ...
        ui_overtime_hours.Location = New Point(477, 212)
        ...
        ui_late_hours.Location = New Point(477, 316)
        ...
        ui_early_hours.Location = New Point(477, 417)
        ...
        Controls.Add(ui_early_hours)
        Controls.Add(ui_late_hours)
        Controls.Add(ui_overtime_hours)
        Controls.Add(ui_office_hours)
        ...
        Controls.Add(Label6)
        Controls.Add(ui_of_date)
        Controls.Add(ui_shift)
        Controls.Add(Label5)
        ...
        Controls.SetChildIndex(ui_shift, 0)
        Controls.SetChildIndex(ui_of_date, 0)
        ...
        Controls.SetChildIndex(ui_office_hours, 0)
        Controls.SetChildIndex(ui_overtime_hours, 0)
        Controls.SetChildIndex(ui_late_hours, 0)
        Controls.SetChildIndex(ui_early_hours, 0)
