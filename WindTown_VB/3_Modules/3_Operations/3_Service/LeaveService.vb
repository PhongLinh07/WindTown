Public Class LeaveService
    ...
    ' Constructor: Ép Service sử dụng LeaveRepository chuyên biệt thay vì GenericRepository
    Public Sub New()
        ' Vì LeaveRepository kế thừa từ GenericRepository(Of Leave), 
        ' nên việc gán này là hoàn toàn hợp lệ (Tính đa hình).
        _repo = New LeaveRepository()
    End Sub
    ...
    Public Overrides Function Execute(intent As DataIntent, Optional data As Object = Nothing) As ServiceResponse(Of Object)
        ...
        ' 1. Bổ sung logic Kiểm tra (Validation) riêng cho Leave
