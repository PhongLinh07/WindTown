Public Class AssignmentService
    ...
    ' Constructor: Ép Service sử dụng AssignmentRepository chuyên biệt thay vì GenericRepository
    Public Sub New()
        ' Vì AssignmentRepository kế thừa từ GenericRepository(Of Attendance), 
