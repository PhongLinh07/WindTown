...
Public Class ProductsForm
        ...
        Private _cfgModel As New ProductModel()
    ...
    Protected Overrides Sub RefreshDgv()
        ...
        Dim _cfgModelResponse As Response(Of ProductModel) = Nothing
    ...
    Protected Overrides Sub tool_new_Click(sender As Object, e As EventArgs)
        ...
        If crud.ShowDialog() = DialogResult.OK Then
            Dim service As New ProductService()
            Dim result As New Response(Of ProductModel)
    ...
    Protected Overrides Sub tool_delete_Click(sender As Object, e As EventArgs)
        ...
        If TypeOf Dgv.DataSource Is BindingList(Of ProductModel) Then
            Dim list As BindingList(Of ProductModel) = CType(Dgv.DataSource, BindingList(Of ProductModel))
            Dim service As New ProductService()
            ' Dim dialog As String = "___Log___" & vbCrLf

            For Each row As DataGridViewRow In Dgv.SelectedRows
                If TypeOf row.DataBoundItem Is ProductModel Then
                    Dim item As ProductModel = CType(row.DataBoundItem, ProductModel)
                    Dim result As New Response(Of ProductModel)
    ...
    Protected Overrides Sub Dgv_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs)
        ...
        Dim data As ProductModel = CType(row.DataBoundItem, ProductModel)

        Dim crud As New ProductCRUD(data)
        If crud.ShowDialog() = DialogResult.OK Then
            Dim service As New ProductService()
            Dim result As Response(Of ProductModel) = Nothing
