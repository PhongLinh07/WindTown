...
Partial Class formLevel
    ...
    Private Sub InitializeComponent()
        ...
        lblFRank = New Label()
        pnlRankCtrl = New Panel()
        lblRankHint = New Label()
        btnRankInc = New Button()
        lblRankNum = New Label()
        btnRankDec = New Button()
        ...
        pnlContent.Size = New Size(782, 401)
        ...
        pnlRight.Location = New Point(461, 0)
        pnlRight.Name = "pnlRight"
        pnlRight.Size = New Size(321, 401)
        pnlRight.TabIndex = 0
        ' 
        ' pnlFormScroll
        ' 
        ...
        pnlFormScroll.Size = New Size(321, 269)
        ...
        tlp.Controls.Add(lblFRank, 0, 2)
        tlp.Controls.Add(pnlRankCtrl, 0, 3)
        ...
        lblFCode.Size = New Size(110, 19)
        lblFCode.TabIndex = 0
        lblFCode.Text = "Mã cấp bậc  *"
        ' 
        ' txtFCode
        ' 
        ...
        txtFCode.ForeColor = Color.FromArgb(CByte(76), CByte(175), CByte(80))
        txtFCode.Location = New Point(0, 22)
        txtFCode.Margin = New Padding(0, 0, 8, 4)
        txtFCode.Name = "txtFCode"
        txtFCode.Size = New Size(110, 26)
        txtFCode.TabIndex = 0
        ' 
        ' lblFName
        ' 
        ...
        lblFName.Location = New Point(126, 0)
        lblFName.Margin = New Padding(8, 0, 0, 0)
        lblFName.Name = "lblFName"
        lblFName.Size = New Size(107, 22)
        lblFName.TabIndex = 1
        lblFName.Text = "Tên cấp bậc  *"
        ' 
        ' txtFName
        ' 
        ...
        txtFName.Size = New Size(110, 28)
        txtFName.TabIndex = 1
        ' 
        ' lblFRank
        ' 
        lblFRank.AutoSize = True
        lblFRank.Font = New Font("Microsoft YaHei UI", 8.5F, FontStyle.Bold)
        lblFRank.ForeColor = Color.FromArgb(CByte(123), CByte(139), CByte(178))
        lblFRank.Location = New Point(3, 62)
        lblFRank.Name = "lblFRank"
        lblFRank.Size = New Size(88, 22)
        lblFRank.TabIndex = 2
        lblFRank.Text = "Thứ hạng  (rank)"
        ' 
        ' pnlRankCtrl
        ' 
        pnlRankCtrl.BackColor = Color.Transparent
        pnlRankCtrl.Controls.Add(lblRankHint)
        pnlRankCtrl.Controls.Add(btnRankInc)
        pnlRankCtrl.Controls.Add(lblRankNum)
        pnlRankCtrl.Controls.Add(btnRankDec)
        pnlRankCtrl.Dock = DockStyle.Fill
        pnlRankCtrl.Location = New Point(0, 88)
        pnlRankCtrl.Margin = New Padding(0, 4, 8, 4)
        pnlRankCtrl.Name = "pnlRankCtrl"
        pnlRankCtrl.Size = New Size(110, 40)
        pnlRankCtrl.TabIndex = 3
        ' 
        ' lblRankHint
        ' 
        lblRankHint.AutoSize = True
        lblRankHint.Font = New Font("Microsoft YaHei UI", 8F)
        lblRankHint.ForeColor = Color.FromArgb(CByte(61), CByte(74), CByte(114))
        lblRankHint.Location = New Point(106, 10)
        lblRankHint.Name = "lblRankHint"
        lblRankHint.Size = New Size(111, 20)
        lblRankHint.TabIndex = 0
        lblRankHint.Text = "(1 = thấp nhất)"
        ' 
        ' btnRankInc
        ' 
        btnRankInc.BackColor = Color.FromArgb(CByte(38), CByte(43), CByte(66))
        btnRankInc.Cursor = Cursors.Hand
        btnRankInc.FlatAppearance.BorderColor = Color.FromArgb(CByte(42), CByte(48), CByte(80))
        btnRankInc.FlatAppearance.MouseOverBackColor = Color.FromArgb(CByte(30), CByte(74), CByte(158), CByte(255))
        btnRankInc.FlatStyle = FlatStyle.Flat
        btnRankInc.Font = New Font("Microsoft YaHei UI", 12F, FontStyle.Bold)
        btnRankInc.ForeColor = Color.FromArgb(CByte(123), CByte(139), CByte(178))
        btnRankInc.Location = New Point(72, 4)
        btnRankInc.Name = "btnRankInc"
        btnRankInc.Size = New Size(28, 28)
        btnRankInc.TabIndex = 1
        btnRankInc.Text = "+"
        btnRankInc.UseVisualStyleBackColor = False
        ' 
        ' lblRankNum
        ' 
        lblRankNum.Font = New Font("Microsoft YaHei UI", 14F, FontStyle.Bold)
        lblRankNum.ForeColor = Color.FromArgb(CByte(245), CByte(158), CByte(11))
        lblRankNum.Location = New Point(32, 2)
        lblRankNum.Name = "lblRankNum"
        lblRankNum.Size = New Size(36, 32)
        lblRankNum.TabIndex = 2
        lblRankNum.Text = "1"
        lblRankNum.TextAlign = ContentAlignment.MiddleCenter
        ' 
        ' btnRankDec
        ' 
        btnRankDec.BackColor = Color.FromArgb(CByte(38), CByte(43), CByte(66))
        btnRankDec.Cursor = Cursors.Hand
        btnRankDec.FlatAppearance.BorderColor = Color.FromArgb(CByte(42), CByte(48), CByte(80))
        btnRankDec.FlatAppearance.MouseOverBackColor = Color.FromArgb(CByte(30), CByte(74), CByte(158), CByte(255))
        btnRankDec.FlatStyle = FlatStyle.Flat
        btnRankDec.Font = New Font("Microsoft YaHei UI", 12F, FontStyle.Bold)
        btnRankDec.ForeColor = Color.FromArgb(CByte(123), CByte(139), CByte(178))
        btnRankDec.Location = New Point(0, 4)
        btnRankDec.Name = "btnRankDec"
        btnRankDec.Size = New Size(28, 28)
        btnRankDec.TabIndex = 3
        btnRankDec.Text = "−"
        btnRankDec.UseVisualStyleBackColor = False
        ' 
        ' lblFStatus
        ' 
        ...
        lblFStatus.Location = New Point(126, 62)
        ...
        cboFStatus.Size = New Size(110, 29)
        ...
        lblFNote.Location = New Point(3, 132)
        ...
        lblSec1.Size = New Size(159, 19)
        lblSec1.TabIndex = 1
        lblSec1.Text = "THÔNG TIN CẤP BẬC"
        ' 
        ' pnlFoot
        ' 
        ...
        btnSave.Location = New Point(980, 10)
        ...
        btnClear.Location = New Point(870, 10)
        ...
        lblHdrTitle.Size = New Size(217, 30)
        lblHdrTitle.TabIndex = 2
        lblHdrTitle.Text = "Thêm cấp bậc mới"
        ' 
        ' pnlHdrIcon
        ' 
        pnlHdrIcon.BackColor = Color.FromArgb(CByte(15), CByte(245), CByte(158), CByte(11))
        ...
        splitter.Location = New Point(460, 0)
        ...
        dgv.Columns.AddRange(New DataGridViewColumn() {colRank, colCode, colName, colEmpCount, colStatus})
        dgv.Cursor = Cursors.Hand
        DataGridViewCellStyle7.Alignment = DataGridViewContentAlignment.MiddleLeft
        DataGridViewCellStyle7.BackColor = Color.FromArgb(CByte(26), CByte(29), CByte(46))
        DataGridViewCellStyle7.Font = New Font("Microsoft YaHei UI", 9.5F)
        ...
        DataGridViewCellStyle3.Font = New Font("Microsoft YaHei UI", 11F, FontStyle.Bold)
        DataGridViewCellStyle3.ForeColor = Color.FromArgb(CByte(245), CByte(158), CByte(11))
        colRank.DefaultCellStyle = DataGridViewCellStyle3
        ...
        ' colCode
        ' 
        DataGridViewCellStyle4.Font = New Font("Courier New", 9F, FontStyle.Bold)
        DataGridViewCellStyle4.ForeColor = Color.FromArgb(CByte(76), CByte(175), CByte(80))
        colCode.DefaultCellStyle = DataGridViewCellStyle4
        ...
        pnlLeftFoot.Size = New Size(460, 36)
        ...
        lblRowInfo.Size = New Size(78, 20)
        lblRowInfo.TabIndex = 0
        lblRowInfo.Text = "0 cấp bậc"
        ' 
        ' pnlToolbar
        ' 
        ...
        pnlToolbar.Size = New Size(782, 52)
        ...
        btnAdd.Location = New Point(1642, 11)
        btnAdd.Name = "btnAdd"
        btnAdd.Size = New Size(200, 30)
        btnAdd.TabIndex = 2
        btnAdd.Text = "+ Thêm cấp bậc"
        ...
        tlp.PerformLayout()
        pnlRankCtrl.ResumeLayout(False)
        pnlRankCtrl.PerformLayout()
    ...
    Friend WithEvents lblFRank As System.Windows.Forms.Label
    Friend WithEvents pnlRankCtrl As System.Windows.Forms.Panel
    Friend WithEvents btnRankDec As System.Windows.Forms.Button
    Friend WithEvents lblRankNum As System.Windows.Forms.Label
    Friend WithEvents btnRankInc As System.Windows.Forms.Button
    Friend WithEvents lblRankHint As System.Windows.Forms.Label
